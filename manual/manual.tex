...
{\setlength{\parindent}{0pt} \Huge SCINE Molassembler 3.0.0}}
...
\begin{Verbatim}
conan install scine_molassembler/3.0.0@
\end{Verbatim}
...
\begin{Verbatim}
conan install -o scine_molassembler:python=True scine_molassembler/3.0.0@
\end{Verbatim}
...
\href{https://scine.ethz.ch/static/download/documentation/molassembler/v3.0.0/cpp}{\texttt{Doxygen}
technical
...
is
\href{https://scine.ethz.ch/static/download/documentation/molassembler/v3.0.0/py}{documented with
