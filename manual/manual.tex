...
{\setlength{\parindent}{0pt} \Huge SCINE Molassembler 1.1.0}}
...
\begin{itemize}
 ...
 i \item the \texttt{Eigen} library $\ge$ 3.3.2, $<$ 3.4.0
\end{itemize}
...
%TODO: Update citation for Utils
...
\href{https://scine.ethz.ch/static/download/documentation/molassembler/v1.1.0/cpp}{\texttt{Doxygen}
technical
...
is
\href{https://scine.ethz.ch/static/download/documentation/molassembler/v1.1.0/py}{documented with
