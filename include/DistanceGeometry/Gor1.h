...
> 
std::enable_if_t<
  std::is_same<IncidenceGraph, MoleculeManip::DistanceGeometry::ImplicitGraph>::value,
  void
> gor1_ig_scan(
  const VertexDescriptor& vertex,
...
>
std::enable_if_t<
  std::is_same<GraphClass, MoleculeManip::DistanceGeometry::ExplicitGraph>::value,
  bool
