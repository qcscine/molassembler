...
if(MKL_FOUND)
  cmessage(STATUS "Found Intel MKL libraries:")
  cmessage(STATUS "${MKL_INCLUDE_DIRS} ")
  cmessage(STATUS "${MKL_INTERFACE_LIBRARY} ")
  cmessage(STATUS "${MKL_THREADING_LIBRARY} ")
  cmessage(STATUS "${MKL_CORE_LIBRARY} ")
  cmessage(STATUS "${MKL_AVX_LIBRARY} ")
  cmessage(STATUS "${MKL_DEF_LIBRARY} ")
else()
