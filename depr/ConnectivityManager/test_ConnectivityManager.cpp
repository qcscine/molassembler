...
BOOST_AUTO_TEST_CASE(insert_stability) {
    std::shared_ptr<ConnectivityManager> test_object =
        std::make_shared<ConnectivityManager>();
...
BOOST_AUTO_TEST_CASE(get_bond_correctness) {
    std::shared_ptr<ConnectivityManager> test_object =
        std::make_shared<ConnectivityManager>();
    AtomIndexType n_atoms = 50;
...
BOOST_AUTO_TEST_CASE(remove_bond_stability) {
    std::shared_ptr<ConnectivityManager> test_object =
        std::make_shared<ConnectivityManager>();
    AtomIndexType n_atoms = 50;
...
BOOST_AUTO_TEST_CASE(remove_atom_stability) {
    std::shared_ptr<ConnectivityManager> test_object =
        std::make_shared<ConnectivityManager>();
    AtomIndexType n_atoms = 50;
